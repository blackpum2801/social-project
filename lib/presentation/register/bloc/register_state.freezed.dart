...
mixin _$RegisterState {
 ...
 RegisterStatus get status; RegisterResponse? get response; String? get errorMessage;
...
@useResult
$Res call({
 RegisterStatus status, RegisterResponse? response, String? errorMessage
});
...
as RegisterResponse?,errorMessage: freezed == errorMessage ? _self.errorMessage : errorMessage // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of RegisterState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( RegisterStatus status,  RegisterResponse? response,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RegisterState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( RegisterStatus status,  RegisterResponse? response,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _RegisterState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( RegisterStatus status,  RegisterResponse? response,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _RegisterState() when $default != null:
return $default(_that.status,_that.response,_that.errorMessage);case _:
  return null;
...
@override final  RegisterResponse? response;
...
@override $RegisterResponseCopyWith<$Res>? get response;

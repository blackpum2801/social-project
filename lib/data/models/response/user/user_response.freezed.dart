...
mixin _$UserResponse {
 ...
 int get id; String get name; String get email;@JsonKey(name: "phone_number") String? get phoneNumber;@JsonKey(name: "avatar") String? get avatar;@JsonKey(name: "nick_name") String? get nickName; String? get banner;@JsonKey(name: "date_of_birth") String? get dateOfBirth; String? get gender; String? get intro;
...
@useResult
$Res call({
 int id, String name, String email,@JsonKey(name: "phone_number") String? phoneNumber,@JsonKey(name: "avatar") String? avatar,@JsonKey(name: "nick_name") String? nickName, String? banner,@JsonKey(name: "date_of_birth") String? dateOfBirth, String? gender, String? intro
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  String email, @JsonKey(name: "phone_number")  String? phoneNumber, @JsonKey(name: "avatar")  String? avatar, @JsonKey(name: "nick_name")  String? nickName,  String? banner, @JsonKey(name: "date_of_birth")  String? dateOfBirth,  String? gender,  String? intro)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  String email, @JsonKey(name: "phone_number")  String? phoneNumber, @JsonKey(name: "avatar")  String? avatar, @JsonKey(name: "nick_name")  String? nickName,  String? banner, @JsonKey(name: "date_of_birth")  String? dateOfBirth,  String? gender,  String? intro)  $default,) {final _that = this;
switch (_that) {
case _UserResponse():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  String email, @JsonKey(name: "phone_number")  String? phoneNumber, @JsonKey(name: "avatar")  String? avatar, @JsonKey(name: "nick_name")  String? nickName,  String? banner, @JsonKey(name: "date_of_birth")  String? dateOfBirth,  String? gender,  String? intro)?  $default,) {final _that = this;
switch (_that) {
case _UserResponse() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.phoneNumber,_that.avatar,_that.nickName,_that.banner,_that.dateOfBirth,_that.gender,_that.intro);case _:
  return null;
...
class _UserResponse implements UserResponse {
  const _UserResponse({required this.id, required this.name, required this.email, @JsonKey(name: "phone_number") this.phoneNumber, @JsonKey(name: "avatar") this.avatar, @JsonKey(name: "nick_name") this.nickName, this.banner, @JsonKey(name: "date_of_birth") this.dateOfBirth, this.gender, this.intro});

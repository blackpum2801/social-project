...
@JsonKey(name: 'post_id') int get postId; String get content;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CommentRequest&&(identical(other.postId, postId) || other.postId == postId)&&(identical(other.content, content) || other.content == content));
}
...
@override
String toString() {
  return 'CommentRequest(postId: $postId, content: $content)';
}
...
@useResult
$Res call({
@JsonKey(name: 'post_id') int postId, String content
});
...
/// Create a copy of CommentRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? postId = null,Object? content = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'post_id')  int postId,  String content)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CommentRequest() when $default != null:
return $default(_that.postId,_that.content);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'post_id')  int postId,  String content)  $default,) {final _that = this;
switch (_that) {
case _CommentRequest():
return $default(_that.postId,_that.content);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'post_id')  int postId,  String content)?  $default,) {final _that = this;
switch (_that) {
case _CommentRequest() when $default != null:
return $default(_that.postId,_that.content);case _:
  return null;
...
class _CommentRequest implements CommentRequest {
  const _CommentRequest({@JsonKey(name: 'post_id') required this.postId, required this.content});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CommentRequest&&(identical(other.postId, postId) || other.postId == postId)&&(identical(other.content, content) || other.content == content));
}
